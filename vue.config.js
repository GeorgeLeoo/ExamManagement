...
const name = 'ExamManagement' // TODO: get this variable from setting.ts

module.exports = {
  publicPath: process.env.NODE_ENV === 'production' ? '/ExamManagement' : '/',
  ...
  devServer: {
    ...
    //     // target: `http://139.159.201.22:3000/mock/11/dev-api`,
